...
{
    compare(ms, SC::M_DEF_LAST_CHOOSEN_DB, SC::M_DEF_PRICE_LITER, SC::M_DEF_FIRM_NAME,
            SC::M_DEF_MILK_INSPECTOR, SC::M_M_DEF_MILK_INSPECTOR2, SC::M_DEF_IS_FETCH_TABLE_ON_REFRESH);
}
