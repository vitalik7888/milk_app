...
void DialogSettings::addCalcColumns()
{
    ...
    addWidgetsColumns(m_gridLayoutCalc, m_columnCalc, m_mainWindow->settings()->getCalc().columns);
}
...
void DialogSettings::addPrintColumns()
{
    ...
    addWidgetsColumns(m_gridLayoutPrint, m_columnPrint, m_mainWindow->settings()->getPrint().columns);
}
